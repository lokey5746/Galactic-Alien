                  ...
                  <>
                    ...
                    blockchain.smartContract === null ? (
                      ...
                      <div className="flex flex-col items-center justify-center w-full">
                        ...
                        <div className="flex items-center space-x-5 md:space-x-10 mt-16">
                          <button
                            className="bg-primary w-20 md:w-32 h-16 text-white font-Boston text-xl rounded-lg"
                          ...
                          <button
                            className="bg-primary  w-16 h-16 text-white font-semibold text-2xl rounded-lg"
                            disabled={claimingNft ? 1 : 0}
                            onClick={(e) => {
                              e.preventDefault();
                              decrementMintAmount();
                          ...
                          <button
                            className="bg-primary h-16 w-16 text-white font-semibold text-2xl rounded-lg"
                            disabled={claimingNft ? 1 : 0}
                            onClick={(e) => {
                              e.preventDefault();
                              incrementMintAmount();
